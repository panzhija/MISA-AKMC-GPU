...
SubLattice::SubLattice(const comm::ColoredDomain *p_domain, const _type_lattice_count seed_time_inc, const double time_limit,
                       const double T)
    : time_inc_dis(0, 1), p_domain(p_domain), T(T), time_limit(time_limit), sec_meta() {
